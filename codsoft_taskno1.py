...
#adding frames
header_frame = tk.Frame(guiWindow, bg = "#CACCCB")
functions_frame = tk.Frame(guiWindow, bg = "#CACCCB") 
listbox_frame = tk.Frame(guiWindow, bg = "#CACCCB")    
